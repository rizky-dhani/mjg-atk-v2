...
return new class extends Migration
{
    ...
    {
        Schema::create('marketing_media_stock_request_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('request_id')->constrained('marketing_media_stock_requests')->onDelete('cascade');
