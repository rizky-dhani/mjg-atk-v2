...
class MarketingMediaDivisionStockSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($divisions as $division) {
            foreach ($items as $item) {
                $setting = MarketingMediaDivisionStockSetting::where('division_id', $division->id)
                ...
                if ($maxLimit > 0) {
                    ...
                    MarketingMediaDivisionStock::updateOrCreate(
                        [
