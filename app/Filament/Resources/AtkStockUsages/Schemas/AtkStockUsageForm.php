            ...
            ->components([
                Section::make('Rejection Details')
                    ->visible(function ($get, $record) {
                        ...
                        $hasRejection = \App\Models\ApprovalHistory::where('approvable_type', 'App\Models\AtkStockUsage')
                            ...
                            ->schema([
                                TextInput::make('rejection_reason')
                                    ...
                                    ->formatStateUsing(function ($record) {
                                        ...
                                        $rejection = \App\Models\ApprovalHistory::where('approvable_type', 'App\Models\AtkStockUsage')
                                            ->where('approvable_id', $record->id)
                                            ->where('action', 'rejected')
                                            ->latest('performed_at')
                                            ->first();
