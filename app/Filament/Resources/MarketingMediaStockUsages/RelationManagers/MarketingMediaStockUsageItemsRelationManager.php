...
namespace App\Filament\Resources\MarketingMediaStockUsages\RelationManagers;
...
class MarketingMediaStockUsageItemsRelationManager extends RelationManager
{
    protected static string $relationship = 'marketingMediaStockUsageItems';
