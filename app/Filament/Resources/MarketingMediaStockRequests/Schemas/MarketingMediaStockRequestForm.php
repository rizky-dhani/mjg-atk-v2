...
class MarketingMediaStockRequestForm
{
            ...
            ->components([
                ...
                Section::make('Rejection Details')
                    ->visible(function ($get, $record) {
                        ...
                        $hasRejection = \App\Models\ApprovalHistory::where('approvable_type', 'App\\Models\\MarketingMediaStockRequest')
                            ...
                            ->schema([
                                TextInput::make('rejection_reason')
                                    ...
                                    ->formatStateUsing(function ($record) {
                                        ...
                                        $rejection = \App\Models\ApprovalHistory::where('approvable_type', 'App\\Models\\MarketingMediaStockRequest')
                                            ->where('approvable_id', $record->id)
                                            ->where('action', 'rejected')
                                            ->latest('performed_at')
                                            ->first();
                ...
                Section::make('Stock Request Items')
                    ->columnSpanFull()
                    ->schema([
                        Repeater::make('marketingMediaStockRequestItems')
                            ->relationship()
                            ->cloneable()
                            ->extraItemActions([
                                    ...
                                    ->rules([
                                        function () {
                                            return function (string $attribute, $value, \Closure $fail, $livewire) {
                                                ...
                                                preg_match('/marketingMediaStockRequestItems\\.(\d+)\\.quantity/', $attribute, $matches);
                                                ...
                                                $itemId = data_get($livewire, "data.marketingMediaStockRequestItems.{$index}.item_id");
