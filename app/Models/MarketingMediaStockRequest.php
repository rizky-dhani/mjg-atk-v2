...
class MarketingMediaStockRequest extends Model
{
    ...
    protected static function booted()
    {
        ...
        static::creating(function ($model) {
            if (empty($model->request_number)) {
                ...
                $model->request_number = \App\Helpers\StockNumberGenerator::generateMarketingMediaRequestNumber($model->division_id);
            }
        });

        static::created(function ($model) {
            // Find an appropriate approval flow for MarketingMediaStockRequest
            $approvalFlow = \App\Models\ApprovalFlow::where('model_type', 'App\Models\MarketingMediaStockRequest')
        ...
        static::deleting(function ($model) {
            ...
            $model->marketingMediaStockRequestItems()->delete();
        });
    }
    ...
    public function marketingMediaStockRequestItems()
    {
        return $this->hasMany(MarketingMediaStockRequestItem::class, 'request_id');
    }
