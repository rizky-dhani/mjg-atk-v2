# add-item-price-snapshot-to-atk-stock-request-item Specification

## Purpose
TBD - created by archiving change add-atk-stock-request-item-price-snapshot. Update Purpose after archive.
## Requirements
