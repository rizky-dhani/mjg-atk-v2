...
8. **Commit Code Changes with Summary:**
   - Stage all code changes related to the task.
   - Draft a detailed commit message. The message should follow the format:
     ```
     ...
     - Brief "why" for the change
     ```
   - Perform the commit using the drafted message.
...
6.  **Create Checkpoint Commit with Verification Report:**
    ...
    -   Perform the commit with a detailed message including the verification report:
        ```
        conductor(checkpoint): Checkpoint end of Phase X

        Verification Report:
        - Automated test command: [Command]
...
9. Detailed task summary included in the commit message
