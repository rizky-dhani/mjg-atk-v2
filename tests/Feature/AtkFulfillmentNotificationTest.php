...
it('notifies the requester when stock is received', function () {
    NotificationFacade::fake();

    app(FulfillmentService::class)->receiveItem($this->requestItem, 10);
    app(FulfillmentService::class)->notifyRequester($this->request, 10, $this->item->name);
